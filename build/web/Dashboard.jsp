                                    ...
                                    <h3 class="panel-title">
                                        ...
                                        <span class="col-lg-offset-9"> 
                                          <!--  <span data-toggle="tooltip" data-placement="bottom" title="Create New VM"> 
                                           ...
                                           <%
                                        out.println("<a href=\"createVM.jsp?user="+str1+"&node="+str2+"\"><button type=\"button\" class=\"btn btn-default\" aria-label=\"Create VM\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Create VM\"> <span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span></button> </a>");
                                        %>     
	...
	<%
				if(state.equals("Running"))
                                {                                    
                                    ...
                                    out.println("<button type=\"button\" class=\"btn btn-default disabled\" aria-label=\"Delete VM\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Delete VM\"> <span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span></button> </a>");
