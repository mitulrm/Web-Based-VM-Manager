...
<html>
    ...
    <%
        ...
        out.println("<div id=\"domainname\" >" + name + "</div>");
    %>
    <div id="mygraph"></div>
    ...
    <script type="text/javascript">
      ...
      //$(document).ready(function(){
        ...
        var cpu_ds_graph_opts={'ns':{ color: "#00c0c0", label: 'CPU Utilization(ns)', 
        ...
        var domainname = document.getElementById("domainname").innerHTML;
        var cpurrd="data/rrd/"+domainname+"/libvirt/virt_cpu_total.rrd";
        var diskoprrd="data/rrd/"+domainname+"/libvirt/disk_octets-hda.rrd";
        var networkrrd="data/rrd/"+domainname+"/libvirt/if_octets-vnet0.rrd";
