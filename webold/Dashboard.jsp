	...
	<%
				if(state.equals("Running"))
                                {                                    
                                    ...
                                    out.println("<a href=\"VMOpsServlet?user="+str1+"&node="+str2+"&op=migrate&name="+name+"&dest="+"\"><button type=\"button\" class=\"btn btn-default\" aria-label=\"Migrate VM\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Migrate VM\"> <span class=\"glyphicon glyphicon-send\" aria-hidden=\"true\"></span></button> </a>");
                                    out.println("<a href=\"http://" + str2 + ":8084/kvmvmmanager/resourceUtilization.jsp?name="+name+"\"><button type=\"button\" class=\"btn btn-default\" aria-label=\"Resource Utilization\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Resource Utilizaion\"> <span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"></span></button> </a>");
        			...
        			{
                                    out.println("<a href=\"VMOpsServlet?user="+str1+"&node="+str2+"&op=resume&name="+name+"\"><button type=\"button\" class=\"btn btn-default\" aria-label=\"Resume VM\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Resume VM\"> <span class=\"glyphicon glyphicon-play\" aria-hidden=\"true\"></span></button> </a>");
