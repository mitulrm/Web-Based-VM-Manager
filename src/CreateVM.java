...
public class CreateVM extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException, LibvirtException, InterruptedException {
...
//		String pathForXMLFile="/var/lib/libvirt/images/";
		...
		String xml=this.createXML(request, response);
...
//                displayerror(out, "Testing... Testing!!");
	...
	private String createXML(HttpServletRequest request, HttpServletResponse response) throws IOException{
