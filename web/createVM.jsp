    ...
    <body>
		...
		<div class="panel-heading" aria-expanded="true">
                ...
                <div class="panel-body">
                    ...
                    //out.println("<form name=\"createvm\" id=\"createvm\" method=\"POST\" action="http://"+str2+"/kvmvmmanager/createVM">");
                    %>
                    <form name="createvm" id="createvm" method="POST" action="http://<%=str2%>:8084/kvmvmmanager/createVM?user=<%=str1%>&node=<%=str2%>">
                    <div id="part1">
			<div class="row">
                            <div class="col-lg-7">
